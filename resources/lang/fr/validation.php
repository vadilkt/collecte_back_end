...
return array(
    ...
    */
    ...
    'custom' => array(
        ...
        "intitule_obj" => [
            "required" => "L'intitule de l'objectif est obligatoire"
        ],
        "intitule_eval" => [
            "required" => "L'intitule de l'evaluateur est obligatoire"
        ],
        "date_deb" => [
        ...
        "valeur_eval" => [
            "required" => "Le resultat attendu est obligatoire"
        ],
        "valeur_score" => [
            "required" => "Le result obtenu est obligatoire"
        ]
    ),
